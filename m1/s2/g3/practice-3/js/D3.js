...
/* ESERCIZIO 4
  Scrivi un algoritmo per verificare che, dati due numeri interi, il valore di 
  uno di essi sia 8 oppure se la loro addizione/sottrazione sia uguale a 8.
*/
...
if(d == 8 || e == 8) {
  console.log('il valore di uno di essi è uguale 8');
} else if(d + e == 8 || d - e == 8){
  console.log('la somma/sottrazione dei due numeri è uguale a 8');
} else {
  console.log('il loro valore e la loro somma/sottrazione non è 8');
}
...
/* ESERCIZIO 5
  ...
  Crea un algoritmo che determini l'ammontare totale che deve essere addebitato 
  all'utente per il checkout.
*/
...
/* ESERCIZIO 6
  Stai lavorando su un sito di e-commerce. Oggi è il Black Friday 
  e viene applicato il 20% su ogni prodotto.
...
if (totalShoppingCart - sconto > 50) {
  ...
  console.log(totalShoppingCart - sconto + 10);
}
